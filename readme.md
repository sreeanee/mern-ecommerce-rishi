...
### Note: A related project involving end-to-end encrypted chat applications using Next.js, Prisma, and Socket.io is also available for exploration.
...
Once both servers are running, you can access them at the following URLs:
...
## About the Developer
SREETHA ANEESH is a Senior Full Stack Developer and Software Engineer with over 5 years of experience in developing enterprise-grade applications. Specializing in the MERN stack, Java, Spring Boot, and modern frontend frameworks, Sreetha focuses on building scalable, high-performance solutions and contributing to robust software delivery workflows.
